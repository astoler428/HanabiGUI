...
public class Player {
	...
	public void setHasChosenClue(String hasChosenClue) { // changed to lowercase for printing in log but also necessary
															// to match cluOptions
		this.hasChosenClue = hasChosenClue.toLowerCase();
	}
